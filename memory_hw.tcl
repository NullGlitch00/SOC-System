...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL memory
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
add_fileset_file memory.v VERILOG PATH memory.v TOP_LEVEL_FILE
...
add_interface_port avalon_slave_0 iAddress address Input ADDRESS_WIDTH
